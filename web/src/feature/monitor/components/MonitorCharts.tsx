                    ...
                    <EChart
                        option={(() => {
                            const tokenSeries: { key: keyof ChartDataPoint; name: string; color: string }[] = [
                                ...
                                { key: 'generalInputTokens', name: t('monitor.charts.tokensBreakdown.generalInput'), color: '#3b82f6' },
                                ...
                                { key: 'generalOutputTokens', name: t('monitor.charts.tokensBreakdown.generalOutput'), color: '#10b981' },
                ...
                <EChart
                    option={(() => {
                        const costBreakdownSeries: { key: keyof ChartDataPoint; name: string; color: string }[] = [
                            ...
                            { key: 'inputAmount', name: t('monitor.charts.costBreakdownTypes.generalInput'), color: '#3b82f6' },
                            ...
                            { key: 'outputAmount', name: t('monitor.charts.costBreakdownTypes.generalOutput'), color: '#10b981' },
